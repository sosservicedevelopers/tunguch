    ...
    public partial class A1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DictCinemaAgeRestrictions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DictCinemaDuration", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DictCinemaRegiser", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LocationPrecise = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GDP = table.Column<double>(nullable: false),
                    GrossValueAdded = table.Column<double>(nullable: false),
                    ShareOfTourismInGDP = table.Column<double>(nullable: false),
                    TaxRevenue = table.Column<double>(nullable: false),
                    TheNumCitizensfromNearAndFar = table.Column<double>(nullable: false),
                    FromCIS = table.Column<double>(nullable: false),
                    FromForeign = table.Column<double>(nullable: false),
                    ...
                    InvestmentsTourismSector = table.Column<double>(nullable: false),
                    ...
                    RevenuesFromTransportTourists = table.Column<double>(nullable: false),
                    TourismTetailSales = table.Column<double>(nullable: false),
                    TurnoverPreparedFood = table.Column<double>(nullable: false),
                    TravelAgencyServices = table.Column<double>(nullable: false),
                    SanatoriumResortActivities = table.Column<double>(nullable: false),
                    ServicesShortTermResidence = table.Column<double>(nullable: false),
                    CreateDate = table.Column<DateTime>(nullable: false),
                    ApplicationUserId = table.Column<string>(nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ListOfCinematographyCertificates_DictCinemaAgeRestrictionsId",
                table: "ListOfCinematographyCertificates",
                column: "DictCinemaAgeRestrictionsId");
